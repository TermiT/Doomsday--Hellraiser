...
void gld_StartDrawScene(void)
{
  ...
  //Com_Printf("gld_StartDrawScene glViewport: %d %d %d %d\n", viewwindowx, SCREENHEIGHT-(height+viewwindowy-((height-viewheight)/2)), viewwidth, height);
  //Com_Printf("gld_StartDrawScene glScissor: %d %d %d %d\n", viewwindowx, SCREENHEIGHT-(viewheight+viewwindowy), viewwidth, viewheight);

...
#define BASE_WIDTH 320 // TERMIT TESTS (320)
...
#else
#error 2
#define INV_ASPECT_RATIO 0.625 /* 0.75, ideally */ // TERMIT TESTS
#endif
...
#ifdef IPHONE			// JDC
#ifdef IPAD
#define MAX_SCREENWIDTH  1024 // TERMIT TESTS (320X480)
#define MAX_SCREENHEIGHT 768
#else
#error 3
#define MAX_SCREENWIDTH  480 // TERMIT TESTS (320X480)
...
/* GENERAL ARCADE HACKS */
#define GA_GAMEMODE registered

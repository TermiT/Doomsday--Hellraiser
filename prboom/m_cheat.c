...
struct cheat_s cheat[] = {
  {"gamus",      "Change music",      always,
   cheat_mus,      -2},

  {"gachoppers", "Chainsaw",          not_net | not_demo,
   cheat_choppers },

  {"gadqd",      "God mode",          not_net | not_demo,
   cheat_god      },
  ...
  {"gakfa",      "Ammo & Keys",       not_net | not_demo,
   cheat_kfa },

  {"gafa",       "Ammo",              not_net | not_demo,
   cheat_fa  },

  {"gaspispopd", "No Clipping 1",     not_net | not_demo,
   cheat_noclip },

  {"gaclip",     "No Clipping 2",     not_net | not_demo,
   cheat_noclip },

  {"gabeholdh",  "Invincibility",     not_net | not_demo,
   cheat_health },

  {"gabeholdm",  "Invincibility",     not_net | not_demo,
   cheat_megaarmour },

  {"gabeholdv",  "Invincibility",     not_net | not_demo,
   cheat_pw,  pw_invulnerability },

  {"gabeholds",  "Berserk",           not_net | not_demo,
   cheat_pw,  pw_strength        },

  {"gabeholdi",  "Invisibility",      not_net | not_demo,
   cheat_pw,  pw_invisibility    },

  {"gabeholdr",  "Radiation Suit",    not_net | not_demo,
   cheat_pw,  pw_ironfeet        },

  {"gabeholda",  "Auto-map",          not_dm,
   cheat_pw,  pw_allmap          },

  {"gabeholdl",  "Lite-Amp Goggles",  not_dm,
   cheat_pw,  pw_infrared        },

  {"gabehold",   "BEHOLD menu",       not_dm,
   cheat_behold   },

  {"gaclev",     "Level Warp",        not_net | not_demo | not_menu,
   cheat_clev,    -2},

  {"gamypos",    "Player Position",   not_dm,
   cheat_mypos    },
